    ...
    <section className="py-24 lg:py-32" style={{ background: 'var(--cream)' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-10 lg:grid-cols-[1.4fr_0.9fr] items-start">
          ...
          {/* ── Right column: card ── */}
          <motion.div
            className="space-y-8 rounded-[2rem] border border-[#F6E2B5] bg-white p-8 shadow-luxury"
            variants={fadeUp}
            initial="hidden"
            whileInView="visible"
          ...
          >
            {/* ── Founder image ── */}
            <div className="rounded-[1.5rem] overflow-hidden w-full">
              <div className="aspect-[4/5] relative bg-[var(--cream)]">
                <img
                  src={cicImageUrl ?? '/haliberry_founder.jpeg'}
                ...
                />
                {/* Fallback — only visible if image truly fails to load */}
                <div
                  className="absolute inset-0 hidden flex-col items-center justify-center gap-4"
                  style={{
                    background: 'linear-gradient(160deg, var(--peach) 0%, var(--cream) 100%)',
                  }}
                  aria-hidden="true"
                >
                ...
                {/* Subtle gradient overlay — lifts the image slightly at the bottom */}
                <div className="absolute inset-x-0 bottom-0 h-1/4 bg-gradient-to-t from-black/10 to-transparent pointer-events-none rounded-b-[1.5rem]" />
              </div>
            </div>
            ...
            <div>
              ...
              <p className="font-sans font-light mt-3 leading-[1.85]" style={{ color: 'var(--text-secondary)' }}>
            ...
            <div className="rounded-[1.75rem] bg-[var(--peach)] p-6 text-white">
              ...
              <p className="font-sans font-light mt-4 leading-[1.85]">
                More than training, we create pathways towards confidence, independence, creativity,
